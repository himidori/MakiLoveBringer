...
#region MeteButtonColor Elemente (Rot, Grun, Blau, Orange, Schwarz, Weiss, Braun, Lila, Pink, Gelb, Dunkelrot, Dunkelgrun, Dunkelblau)
...
public sealed class AnimatedVerticalTabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        //COLOR: Hintergrund TabView (Tab-Behalter hiintergrund)
